...
export const AnimatedTestimonials = ({
	...
	return (
		<div className="w-full mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20 bg-black">
			<div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
				<div className="w-full">
					<div className="relative lg:h-80 md:h-60 h-40">
						<AnimatePresence>
							{testimonials.map((testimonial, index) => (
								...
								>
									<Image
										...
										height={500}
										draggable={false}
										className="h-full max-w-80 rounded-3xl object-cover object-center"
									/>
								</motion.div>
							))}
						</AnimatePresence>
