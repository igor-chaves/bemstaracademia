...
const Footer = () => {
	...
	const linksUteis = [
		{ link: "Testemunhos", href: "#testemunhos" },
	...
	return (
		<footer className="w-full bg-orange-300 ">
			<div className="footer text-base-content max-w-[1280px] w-full mx-auto p-10">
				<aside className="text-gray-700">
					...
					<p>
						Academia Bemstar <br /> Promovendo saúde à comunidade Tricordiana
					</p>
				</aside>
